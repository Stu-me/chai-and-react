        ...
        <div>
            <div className="max-w-2xl px-8 py-4 bg-white rounded-lg shadow-md dark:bg-gray-800">
                ...
                <div className="mt-2">
                    ...
                    <p className="mt-2 text-gray-600 dark:text-gray-300">{props.intro}</p>
                </div>
                ...
                <div className="flex items-center justify-between mt-4">
                    ...
                    <div className="flex items-center">
                        ...
                        <a className="font-bold text-gray-700 cursor-pointer dark:text-gray-200" tabIndex="0" role="link">{props.name}</a>
                    </div>
                </div>
            </div>
